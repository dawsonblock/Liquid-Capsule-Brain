"""Management of the engine's belief state and working memory summary."""
...
class BeliefStateManager:
    """Manages the AGI's working memory and derived state."""
    ...
    def synthesize_context_for_llm(self) -> tuple[str, str]:
        ...
        retrieved = " | ".join(self.retrieved_knowledge[:5])
        context_lines = [
