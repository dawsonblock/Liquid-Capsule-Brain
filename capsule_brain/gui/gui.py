...
class AdvancedGUI:
    """A thin wrapper that exposes websocket endpoints for the engine."""

    def __init__(self, engine: Any, app: FastAPI):
        self.engine = engine
        self.app = app
    ...
    async def run_broadcasters(self) -> None:
        if not getattr(self.engine, "bus", None):
            return
        ...
        while True:
            try:
                ...
                logger.error("GUI broadcaster error: %s", exc)
