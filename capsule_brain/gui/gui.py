"""Minimal FastAPI-based GUI for the Capsule Brain engine."""
...
class AdvancedGUI:
    ...
    def _setup_routes(self) -> None:
        ...
        async def root() -> FileResponse:  # pragma: no cover - exercised via integration
        ...
        async def websocket_endpoint(
            ...
            admin_token = SecretManager.get_secret("ADMIN_API_KEY")
