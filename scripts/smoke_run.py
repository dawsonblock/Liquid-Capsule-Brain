...
MetricEntry = tuple[dict[str, str], float]
MetricSet = dict[str, list[MetricEntry]]


def scrape_metrics(client: httpx.Client) -> MetricSet:
...
def counter_for(metrics: MetricSet, name: str, labels: dict[str, str]) -> float:
    total = 0.0
